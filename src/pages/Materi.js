...
const Materi = () => {
  ...
  useEffect(() => {
    const mockBiologies = [
      ...
      { id: 3, name: 'Proses Pengaturan pada Tumbuhan', description: 'Proses Pengaturan pada Tumbuhan', image: 'https://i.pinimg.com/736x/85/ac/bf/85acbf638f26a2d347b71de3b2d12a65.jpg', category: 'Bab 3', link: '/bab3' },
      ...
      { id: 7, name: 'Evolusi', description: 'Evolusi', image: 'https://cdn.prod.website-files.com/62041b52ed8a5756a8361408/650b76b2a66ebc491e52d45f_abundance-2.jpg', category: 'Bab 7', link: '/bab7' },
