...
const Bab6 = () => {
  ...
  return (
    <div className="bab4-container">
      ...
      <h2>A. Pautan </h2>
        <p>
        <img src="bab6a.png" alt="Struktur Penyerapan Makanan" className="section-image" />
        ...
        <p>Pindah silang (crossing over) merupakan peristiwa pertukaran gen karena kromosom homolog saling melilit saat meiosis. 
          ...
          <img src="bab6b.png" alt="Struktur Penyerapan Makanan" className="section-image" />
          ...
          <img src="bab6c.png" alt="Struktur Penyerapan Makanan" className="section-image" />
          Ciri Pindah silang:
        ...
        <img src="bab6d.png" alt="Struktur Penyerapan Makanan" className="section-image" />
      ...
      <section>
        ...
        Dan bila lebih besar dari setengah dan lebih kecil dari satu lalat tersebut merupakan lalat intersex.
        <img src="bab6e.png" alt="Struktur Penyerapan Makanan" className="section-image" />
        contoh:
        ...
        ada makhluk hidup lain penentuan jenis kelaminnya seperti pada tabel berikut:
        <img src="bab6f.png" alt="Struktur Penyerapan Makanan" className="section-image" />
        </p>
        <h2>F. Gen Lethal</h2>
